...
int	main(int main_argc, char **main_argv)
{
	...
	char infpath[120]{};
	strcpy(infpath, "C://PARA//thread_test_yc.txt");
	...
	//for (int thread_inx = 0; thread_inx != 4; thread_inx++)
		...
		//char  inImgFile[121] = { "I://xu//CHESS_PARALLEL//Data//xf_ws//geo//" };
		//char  inFlowFile[121] = { "I://xu//CHESS_PARALLEL//Data//xf_ws//geo//" };
		//char  inClimPath[121] = { "I://xu//CHESS_PARALLEL//Data//xf_ws//clim//" };

		//char  inDefFile[121] = { "I://xu//CHESS_PARALLEL//Data//xf_ws//defs//" };
		//char  outPutPath[121] = { "I://xu//CHESS_PARALLEL//Data//xf_ws//out//" };

		char  inImgFile[121] = { "C://PARA//xf_ws//geo//" };
		char  inFlowFile[121] = { "C://PARA//xf_ws//geo//" };
		char  inClimPath[121] = { "C://PARA//xf_ws//clim//" };

		char  inDefFile[121] = { "C://PARA//xf_ws//defs//" };
		char  outPutPath[121] = { "C://PARA//xf_ws//out//" };
		...
		for (current_date.year = start_year; current_date.year <= endyear; current_date.year++) {
			...
			for (current_date.month = firstmonth; current_date.month <= lastmonth; current_date.month++) {
				...
				for (current_date.day = firstday; current_date.day <= lastday; current_date.day++) {
					...
					t2 = clock();
					land_time += (float)(t2 - t1) / CLOCKS_PER_SEC;
					...
					t3 = clock();
					channel_time += (float)(t3 - t2) / CLOCKS_PER_SEC;
